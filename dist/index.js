...
let convert;
try {
	convert = __nccwpck_require__(276)/* .convert */ .O;
} catch (e) {}
...
var iconvLite = __nccwpck_require__(989);
// Load Iconv from an external file to be able to disable Iconv for webpack
// Add /\/iconv-loader$/ to webpack.IgnorePlugin to ignore it
var Iconv = __nccwpck_require__(508);
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(667) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    ...
    'eucjp': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(653) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
    },
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(334) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(334).concat(__nccwpck_require__(714)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(334).concat(__nccwpck_require__(714)) },
        gb18030: function() { return __nccwpck_require__(621) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(442) },
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(453) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __nccwpck_require__(453).concat(__nccwpck_require__(848)) },
...
var bomHandling = __nccwpck_require__(582),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __nccwpck_require__(782); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __nccwpck_require__(383)(iconv);
    }

    // Load Node primitive extensions.
    __nccwpck_require__(834)(iconv);
}
...
(() => {
// Get URL 
const {URL} = __nccwpck_require__(608)
